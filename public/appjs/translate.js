...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if(document.getElementById('Dashboard.Navbar.Elements') != undefined) {
        ...
        // Add Projects
        if(checkPermission('web.projects.user.*')) {
            navbar.innerHTML += `
            <li class="nav-item">
        ...
        // Add Events
        if(checkPermission('web.events.user.*')) {
            navbar.innerHTML += `
            <li class="nav-item">
        ...
        // User Management
        if(checkPermission('web.usermanagment.*')) {
            navbar.innerHTML += `
            <li class="nav-item">
