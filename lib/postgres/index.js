...
const UsersCreate = (username, email, password, language, design, user_group, avatar_url, first_name, last_name, bio) => {
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      await client.query(`INSERT INTO users (username, email, password, user_group, avatar_url, first_name, last_name, bio) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`, [username, email, password, user_group, avatar_url, first_name, last_name, bio]);
