class oAuthPermissions {
    constructor() {
        ...
        this.permissionsSQLFields = {
            "USER:ID:READ": ["users.id", "users.puuid"],
    ...
    /**
     * Check there are any activities, return the required activity name or if not return false
     * @param {Number} combInt 
     * @returns 
     */
    ...
    /**
     * Validate if the combInt is returning a valid permission
     */
