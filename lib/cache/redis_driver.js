 ...
 * @param {Object} time 
 */
const addWebtoken = (webtoken, user_id, username, avatar_url, permissions, browser, language, design, time) => {
    return new Promise(async (resolve, reject) => {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        if (inCache) {
            ...
            if (dbResult.length === 1) {
                ...
                addWebtoken(token, dbResult[0].user_id, dbResult[0].username, dbResult[0].avatar_url, Formated_Permissions, dbResult[0].browser, dbResult[0].language, dbResult[0].design, dbResult[0].time);
