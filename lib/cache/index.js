if (process.env.CACHEDRIVER === "local") {
    ...
    module.exports = {
        ...
        writeOverwriteCacheKey: local.writeOverwriteCacheKey,
        deleteOverwriteCacheKey: local.deleteOverwriteCacheKey,
    ...
    module.exports = {
        ...
        writeOverwriteCacheKey: redis.writeOverwriteCacheKey,
        deleteOverwriteCacheKey: redis.deleteOverwriteCacheKey,
        ...
        getUUIDRouteOwner: redis.getUUIDRouteOwner
    };
} else {
