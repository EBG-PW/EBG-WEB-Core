...
class S3ErrorWrite extends CustomError {
    /**
     * Error when interacting with S3
     * @param {String} message | The message to display to the user
     * @param {String} bucket | The bucket that was used
     * @param {String} object | The object that was used
     */
    constructor(message, bucket, object) {
        super(message);

        this.info = 'Error interacting with S3'
        this.reason = 'Error writing object to S3';
        this.bucket = `Bucket: ${bucket} Object: ${object}`;
        this.object = object;
        this.status = 500;
        this.name = 'S3ErrorWrite';
    }
}

class S3ErrorRead extends CustomError {
    /**
     * Error when interacting with S3
     * @param {String} message | The message to display to the user
     * @param {String} bucket | The bucket that was used
    ...
    constructor(message, bucket, object) {
        ...
        this.info = 'Error interacting with S3'
        this.reason = 'Error reading object from S3';
        this.secret_reason = `Bucket: ${bucket} Object: ${object}`;
        this.object = object;
        this.status = 500;
        this.name = 'S3ErrorRead';
    }
}
